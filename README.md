...
<h2>Deploy</h2>
<p>
O front-end da aplicação foi publicado com a Vercel. O back-end está publicado na Render. A URL gerada pela Render permite que o front consuma a API normalmente.</p>
...
<p>
Clone o repositório, crie um arquivo <code>.env</code> baseado no exemplo disponível, instale as dependências com <code>npm install</code>, e (opcionalmente) ajuste o regex do CORS no backend para testes com a interface gráfica.
</p>
